...
public class Main {
    ...
    public static ToursHanoi jouerPartie(ToursHanoi tourH1) {
        ...
        while (partieActif) {
            ...
            valeurValide = false;
            while (!valeurValide) {
                System.out.println("Entrez la lettre de la tour qui contient l'anneau a deplacer ou 0 pour quitter la partie");
                de = input();
                switch(de) {
                    case 'A':
                        deEnChiffre=1;
            ...
            while (!valeurValide) {
                ...
                System.out.println("Entrez la lettre de la tour vers laquelle on va deplacer l'anneau ou 0 pour terminer la partie");
                vers = input();
                switch(vers) {
                    case 'A':
                        versEnChiffre=1;
    ...
    public static void main (String[] args) {
        ...
        while (var) {
            ...
            System.out.print("Faites votre choix et appuyez sur ENTER : ");
            ...
            switch(inpVar) {
                case 1:
                    ...
                    System.out.println();
                    System.out.println("Combien d'anneaux veux-tu pour ce jeux?");
                    inpChar = input();
                    inpNombre = inpChar - '0';
